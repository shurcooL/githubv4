...
{{range .data.__schema.types | sortByName}}{{if and (eq .kind "INPUT_OBJECT") (not (skip .name))}}
...
func t(text string) *template.Template {
	...
	return template.Must(template.New("").Funcs(template.FuncMap{
		"skip": func(name string) bool {
			// The CustomPropertyValue scalar could use some thought: how to best represent using
			// Go types a GraphQL primitive that "can be either a string or an array of strings"?
			// See https://docs.github.com/en/graphql/reference/scalars#custompropertyvalue.
			//
			// A simple answer may be to use the 'any' type in Go, but is there a better approach?
			return strings.Contains(name, "CustomProperty")
		},
