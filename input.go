...
type UpdateProjectNextItemFieldInput struct {
	...
	ItemID ID `json:"itemId"`
	// The id of the field to be updated. Only supports custom fields and status for now. (Required.)
